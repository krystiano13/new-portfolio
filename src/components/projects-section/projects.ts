...
export const projects: Projects = [
  {
    ...
    description:
      "Water tracker is a simple mobile app that tracks the amount of water consumed by the user." +
  ...
  },
  {
    ...
    title: "POLYBLAST",
    description:
      "Polyblast is a 2D rougelite shooter made with Javascript game engine called - Gdevelop. Game is hugely inspired by other games such as Vampire Suvivors, 20 minutes till dawn and Brotato. Still in production",
