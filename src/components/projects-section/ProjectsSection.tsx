  ...
  return (
    <Fragment>
      ...
      <div className="w-full flex flex-col md:flex-row flex-wrap gap-4 justify-between">
        {projects.map((item) => (
          <div className="flex-1 dark:shadow-zinc-800 cursor-pointer transition-shadow hover:shadow-md w-full lg:w-auto border dark:border-zinc-700 border-gray-200 rounded-lg flex flex-col">
            <img
            ...
            <div className="w-full h-full flex flex-col justify-between p-2">
              ...
              <div className="w-full flex flex-wrap gap-2 mt-3 items-center">
                {item.tags.map((tag) => (
                  <div className="text-xs dark:bg-black dark:border dark:border-zinc-700 dark:text-gray-200 font-medium bg-gray-200 text-gray-800 px-2 py-1">
                    {tag}
                  </div>
                ))}
              </div>
