    ...
    <Fragment>
      ...
      <div className="w-full flex flex-wrap gap-1">
        {skills.map((item) => (
          <div
            style={{ flex: "1 1 0px" }}
            className="p-6 dark:shadow-zinc-800 cursor-pointer transition-shadow hover:shadow-md border dark:border-zinc-700 border-gray-200 rounded-lg w-22 flex flex-col items-center gap-2 justify-center"
          >
            <i
